...
const VoidChat: React.FC<VoidChatProps> = ({ web3, viewAddress, lauArea, lauAddress, user, addLog, refreshTrigger, requestedGap, onGapRequestHandled, onChunkLoaded, onViewIdentity }) => {
